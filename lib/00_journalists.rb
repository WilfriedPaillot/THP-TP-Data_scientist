...
def fiveChar(array)
  ...
  puts "Il y a #{count} handles contenant 5 caractères (hors @)"
end
...
# créer un hash avec les tailles des handles
...
def perform
  ...
  fiveChar(array)
  puts ""
  puts "Array des handles triés par ordre alphabétique"
  sortHandlesByAtoZ(array)
  puts ""
  puts ""
  puts "Array de handles trié par leur taille"
  sortHandlesBySize(array)
  puts ""
  print "Le handle @epenser est en position: "
  positionOf(array)
  puts ""
  puts ""
  puts "Hash des handles comptant le même nombre de catactères"
  repartition(array)
end
